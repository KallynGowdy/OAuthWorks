...
namespace OAuthWorks.Implementation
{
    ...
    public enum AuthorizationResultErrorType
    {
        ...
        [PortableOAuthWorks.DataAnnotations.Description("The given authorization grant (Access Token) does not exist.")]
        MissingGrant,
        ...
        [PortableOAuthWorks.DataAnnotations.Description("The given authorization grant (Access Token) has been revoked and therefore is no longer valid.")]
        RevokedGrant,
        ...
        [PortableOAuthWorks.DataAnnotations.Description("The given authorization grant (Access Token) has expired and therefore is no longer valid. Use the granted refresh token to gain another grant.")]
        ExpiredGrant,
        ...
        [PortableOAuthWorks.DataAnnotations.Description("The given authorization grant (Access Token) has not been granted access to one or more of the required scopes.")]
        ...
        [PortableOAuthWorks.DataAnnotations.Description("The specified type for the grant is not supported for authentication.")]
