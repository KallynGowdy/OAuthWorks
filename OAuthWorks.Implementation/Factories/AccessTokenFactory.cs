...
namespace OAuthWorks.Implementation.Factories
{
    ...
    public static class AccessTokenFactory
    {
        ...
        {
            if (length <= 0) throw new ArgumentOutOfRangeException("length", "The given length must be greater than or equal to 1.");
            using (RNGCryptoServiceProvider rng = new RNGCryptoServiceProvider())
            {
    ...
    public class AccessTokenFactory<TId> : IAccessTokenFactory<HashedAccessToken<TId>>
    {
        ...
        {
            if (tokenLength < 10) throw new ArgumentOutOfRangeException("tokenLength", "tokenLength must be greater than or equal to 10.");
            if (tokenLifetime < 1) throw new ArgumentOutOfRangeException("tokenLifetime", "tokenLifetime must be greater than or equal to 1");
            if (idFormatter == null) throw new ArgumentNullException("idFormatter");
            if (idValueGenerator == null) throw new ArgumentNullException("idValueGenerator");
