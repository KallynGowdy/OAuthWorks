...
namespace OAuthWorks.Factories
{
    ...
    public interface IAuthorizationCodeResponseFactory : IFactory<ISuccessfulAuthorizationCodeResponse>
    {
        ...
        ISuccessfulAuthorizationCodeResponse Create(string authorizationCode, string state);
        ...
        IUnsuccessfulAuthorizationCodeResponse CreateError(AuthorizationCodeRequestErrorType errorCode, string errorDescription, Uri errorUri, string state, Exception innerException);
    }
}
