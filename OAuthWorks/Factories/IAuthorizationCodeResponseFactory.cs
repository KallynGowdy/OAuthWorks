...
namespace OAuthWorks.Factories
{
    ...
    public interface IAuthorizationCodeResponseFactory : IFactory<ISuccessfulAuthorizationCodeResponse>
    {
        ...
        IUnsuccessfulAuthorizationCodeResponse CreateError(AuthorizationCodeRequestErrorType errorCode, string errorDescription, Uri errorUri, string state, Uri redirectUri, Exception innerException);
    }
}
